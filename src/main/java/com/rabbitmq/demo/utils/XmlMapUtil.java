...
public class XmlMapUtil
{
    ...
    public static String map2xml(Map<String, String> map, String rootElement)
    {
        ...
        map.forEach((k,v) ->{
            newMap.put(k,addSymbol(v));
        });
        StringBuffer xmlStr = new StringBuffer("");
        if (map.isEmpty())
            return xmlStr.toString();
        xmlStr.append("<" + rootElement + ">");
        map2Element(newMap, xmlStr);
        xmlStr.append("</" + rootElement + ">");
        return xmlStr.toString();
    }
    ...
    public static String map2xml(Map<String, String> map)
    {
        ...
        for (String key : map.keySet()) {
            xmlStr.append("<" + key + ">" + map.get(key) + "</" + key + ">");
        }
        xmlStr.append("</xml>");
        return xmlStr.toString();
    }
    private static String addSymbol(String value){
        return "<![CDATA[" + value + "]]>";
    }
